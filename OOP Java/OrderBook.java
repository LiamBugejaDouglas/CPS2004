...
public class OrderBook extends Crypto{
    ...
    private float sellBuyPrice;
    private float total;
    private float volumeExecuted;
    private String status;

    //Constructing OrderBook with specified variables
    public OrderBook(String transID, String userID, String function, String type, float quantity, String name, float valueDollar, float sellBuyPrice, float total, String symbol, float volumeExecuted, String status){
    ...
    public static Comparator<OrderBook> OrderBookPrice = new Comparator<OrderBook>(){

        public int compare(OrderBook o1, OrderBook o2){

            float OrderO1 = o1.getValDollar();
            float OrderO2 = o2.getValDollar();
